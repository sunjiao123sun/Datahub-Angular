...
function runTests() {
    ...
    describe('Test if the files from the "' + dir + '" directory have the expected content', function () {
        ...
        it('"manage.html" should contain the correct jQuery version in the CDN URL', function (done) {
        ...
        it('"manage.html" should contain the correct jQuery version in the local URL', function (done) {
